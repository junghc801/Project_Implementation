...
My final selection is 'Weather Forecaster'(weather tracker). I can store weather data in my style if I design the implementation, in other words, I can reduce data preprocessing workload before analysis. My ideal goal is to make a data analysis project from collected weather data.
